...
func TestThrows(t *testing.T) {
	...
	tests := []Test{
		...
		{Script: `true && fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},
		{Script: `false && fn(){throw('abcde')}()`, RunOutput: false},
		{Script: `true || fn(){throw('abcde')}()`, RunOutput: true},
		{Script: `false || fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},
		{Script: `true && true && fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},
		{Script: `true && false && fn(){throw('abcde')}()`, RunOutput: false},
		{Script: `true && fn(){throw('abcde')}() && true`, RunError: fmt.Errorf("abcde")},
		{Script: `false && fn(){throw('abcde')}() && fn(){throw('abcde')}() `, RunOutput: false},

		{Script: `true && fn(){throw('abcde')}() || false`, RunError: fmt.Errorf("abcde")},
		{Script: `true && false || fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},
		{Script: `true && true || fn(){throw('abcde')}()`, RunOutput: true},

		{Script: `true || fn(){throw('abcde')}() || fn(){throw('abcde')}()`, RunOutput: true},
		{Script: `false || fn(){throw('abcde')}() || true`, RunError: fmt.Errorf("abcde")},
		{Script: `false || true || fn(){throw('abcde')}()`, RunOutput: true},
		{Script: `false || false || fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},

		{Script: `false || false && fn(){throw('abcde')}()`, RunOutput: false},
		{Script: `false || true && fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},
		{Script: `false || fn(){throw('abcde')}() || true`, RunError: fmt.Errorf("abcde")},

		{Script: `1 == 1 && fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},
		{Script: `1 == 2 && fn(){throw('abcde')}()`, RunOutput: false},
		{Script: `1 == 1 || fn(){throw('abcde')}()`, RunOutput: true},
		{Script: `1 == 2 || fn(){throw('abcde')}()`, RunError: fmt.Errorf("abcde")},

		{Script: `(true || fn(){throw('abcde')}()) && (true || fn(){throw('hello')}())`, RunOutput: true},
		{Script: `(true || fn(){throw('abcde')}()) && (true && fn(){throw('hello')}())`, RunError: fmt.Errorf("hello")},
		{Script: `(true || fn(){throw('abcde')}()) || (true && fn(){throw('hello')}())`, RunOutput: true},
		{Script: `(true && fn(){throw('abcde')}()) && (true && fn(){throw('hello')}())`, RunError: fmt.Errorf("abcde")},
		{Script: `(true || fn(){throw('abcde')}()) && (false || fn(){throw('hello')}())`, RunError: fmt.Errorf("hello")},
	}
	runTests(t, tests, nil, &Options{Debug: true})
}
...
func TestSwitch(t *testing.T) {
	...
	tests := []Test{
		...
		{Script: `a = fn() { return 1 }; switch a() {case 1: return 5}`, RunOutput: int64(5)},
		{Script: `a = fn() { return 2 }; switch a() {case 1: return 5}`},
		{Script: `a = fn() { return 5 }; b = 1; switch b {case 1: return a() }`, RunOutput: int64(5), Output: map[string]interface{}{"b": int64(1)}},
		{Script: `a = fn() { return 6 }; b = 2; switch b {case 1: return a() }`, Output: map[string]interface{}{"b": int64(2)}},
...
func TestForLoop(t *testing.T) {
	...
	tests := []Test{
		...
		{Script: `fn x() { return [1] }; for b in x() { if b == 1 { break } }`, RunOutput: nil},
		{Script: `fn x() { return [1, 2] }; for b in x() { if b == 2 { break } }`, RunOutput: nil},
		{Script: `fn x() { return [1, 2, 3] }; for b in x() { if b == 3 { break } }`, RunOutput: nil},

		{Script: `fn x() { a = 1; for { if a == 1 { return } } }; x()`, RunOutput: nil},
		{Script: `fn x() { a = 1; for { if a == 1 { return nil } } }; x()`, RunOutput: nil},
		{Script: `fn x() { a = 1; for { if a == 1 { return true } } }; x()`, RunOutput: true},
		{Script: `fn x() { a = 1; for { if a == 1 { return 1 } } }; x()`, RunOutput: int64(1)},
		{Script: `fn x() { a = 1; for { if a == 1 { return 1.1 } } }; x()`, RunOutput: float64(1.1)},
		{Script: `fn x() { a = 1; for { if a == 1 { return "a" } } }; x()`, RunOutput: "a"},

		{Script: `fn x() { for a in [1, 2, 3] { if a == 3 { return } } }; x()`, RunOutput: nil},
		{Script: `fn x() { for a in [1, 2, 3] { if a == 3 { return 3 } }; return 2 }; x()`, RunOutput: int64(3)},
		{Script: `fn x() { for a in [1, 2, 3] { if a == 1 { continue } } }; x()`, RunOutput: nil},
		{Script: `fn x() { for a in [1, 2, 3] { if a == 1 { continue };  if a == 3 { return } } }; x()`, RunOutput: nil},

		{Script: `fn x() { return [1, 2] }; a = 1; for i in x() { a++ }`, RunOutput: nil, Output: map[string]interface{}{"a": int64(3)}},
		{Script: `fn x() { return [1, 2, 3] }; a = 1; for i in x() { a++ }`, RunOutput: nil, Output: map[string]interface{}{"a": int64(4)}},
		...
		{Script: `fn x() { for a = 1; a < 3; a++ { if a == 1 { return a } } }; x()`, RunOutput: int64(1)},
		{Script: `fn x() { for a = 1; a < 3; a++ { if a == 2 { return a } } }; x()`, RunOutput: int64(2)},
		{Script: `fn x() { for a = 1; a < 3; a++ { if a == 3 { return a } } }; x()`, RunOutput: nil},
		{Script: `fn x() { for a = 1; a < 3; a++ { if a == 4 { return a } } }; x()`, RunOutput: nil},

		{Script: `fn x() { a = 1; for b = 1; a < 3; a++ { if a == 1 { continue } }; return a }; x()`, RunOutput: int64(3)},
		{Script: `fn x() { a = 1; for b = 1; a < 3; a++ { if a == 2 { continue } }; return a }; x()`, RunOutput: int64(3)},
		{Script: `fn x() { a = 1; for b = 1; a < 3; a++ { if a == 3 { continue } }; return a }; x()`, RunOutput: int64(3)},
		{Script: `fn x() { a = 1; for b = 1; a < 3; a++ { if a == 4 { continue } }; return a }; x()`, RunOutput: int64(3)},
		...
		{Script: `a = make(chan int64); go fn() { a <- 1; a <- 2; a <- 3 }(); b = []; for i in a { b += i; if i > 2 { break } }`, RunOutput: nil, Output: map[string]interface{}{"b": []interface{}{int64(1), int64(2), int64(3)}}},
		{Script: `a = make(chan int64); go fn() { a <- 1; a <- 2; a <- 3; close(a) }(); b = []; for i in a { b += i }`, RunOutput: nil, Output: map[string]interface{}{"b": []interface{}{int64(1), int64(2), int64(3)}}},
	}
	runTests(t, tests, nil, &Options{Debug: true})
}
